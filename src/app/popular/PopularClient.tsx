    ...
    <div className="space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-sm" style={{ color: "rgb(var(--muted))" }}>
          Globalna rang lista je ista za sve korisnike. Vremenska komponenta omogućuje pregled po
          danu/mjesecu/godini. Popularnost se računa kombinacijom vanjskih signala (Spotify, Last.fm) i
          internih interakcija korisnika.
        </p>
      </header>
      ...
      {loading ? (
        ...
        <div
          className="py-8 text-center rounded-2xl border"
      ...
      >
        ...
        <ul className="text-xs space-y-1" style={{ color: "rgb(var(--muted))" }}>
          <li>
            <strong>Izvođači:</strong> Spotify popularnost × 10 + log(pratitelji) × 40 + log(Last.fm slušatelji) × 30
            + interni lajkovi × 5
          </li>
          <li>
            <strong>Koncerti:</strong> Broj izvođača × 50 + spremljeno × 10 + pregleda × 1
          </li>
        </ul>
      </section>
    </div>
